...
!function (a, b) {
    ...
    return function (a, b, c) {
        ...
        c.namespaces = {
            ...
            d = c.extend({}, e, d);
            for (var f = [], g = !0,
                     h = 0; h < a.length; h += 2)void 0 === c.getMultiValue(b[h / 2].value) ? d.fillHoles || (g = !0) : (d.increasingX && h >= 2 && a[h] <= a[h - 2] && (g = !0), g && (f.push({
                pathCoordinates: [],
                valueData: []
        ...
        c.Interpolation = {}, c.Interpolation.none = function (a) {
            ...
            return function f(b, g) {
                ...
                if (h.length) {
                    ...
                    for (var j, k = (new c.Svg.Path).move(b[0], b[1], !1, g[0]), l = 0,
        ...
        function t(a, b, d) {
            for (var e = new c.Svg.Path(b, d), f = 0; f < a.length; f++)for (var g = a[f],
                                                                                 h = 0; h < g.pathElements.length; h++)e.pathElements.push(g.pathElements[h]);
            return e
        }
